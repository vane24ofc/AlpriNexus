          ...
          {course.interactiveContent && (
           ...
           <Card>
            ...
            <CardContent className="text-center">
                <div className="relative w-32 h-32 mx-auto mb-0 -mt-2"> {/* Added -mt-2 */}
                ...
                <p className={`text-sm mt-1 mb-2 ${allLessonsCompleted ? "text-accent font-semibold" : "text-muted-foreground font-medium"}`}>
